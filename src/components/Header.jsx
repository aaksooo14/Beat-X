        ...
        <>
            <div className="navbar bg-orange-100">
                <div className="flex-1">
                    <Link to={'/'} className="text-xl font-bold">Beat-X</Link>
                </div>
                <div className="flex space-x-5">
                    ...
                    <div>
                        ...
                        {
                            toggle && <div className="fixed right-0 top-0 w-[60vw] h-[100vh]  bg-gray-100 z-10 ">
                                <div className="flex flex-col items-center justify-center pt-[30vh] space-y-5">
                                    ...
                                    <Link to={'/cart'}><p className="text-2xl">Cart</p></Link>
